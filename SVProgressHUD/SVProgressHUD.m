...
- (instancetype)initWithFrame:(CGRect)frame {
    if((self = [super initWithFrame:frame])) {
        ...
        _foregroundColor = [UIColor colorWithRed:(0.6000) green:(0.0000) blue:(0.0549) alpha:(1.0)];
        self.alpha = 0.0f;
...
- (void)showStatus:(NSString *)status {
    ...
    // Show overlay
    //Background view color of hud(Manish)
    self.overlayView.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.40];
